...
local_css(r"C:\Users\RAJ KUMAR GUBBALA\Downloads\StreamLit\project1\style\style.css")
...
with st.container():
    selected = option_menu(
        menu_title = None,
        options = ['About','Projects','Certifications','Contact'],
        icons = ['person','code-slash','award','chat-left-text-fill'],
